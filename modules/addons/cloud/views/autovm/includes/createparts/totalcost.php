    ...
    <div class="col-12 m-0 p-0 px-2" style="--bs-bg-opacity: 0.1;">
        <div class="py-5 px-3 px-lg-5 bg-secondary rounded-4" style="--bs-bg-opacity: 0.1;">
            ...
            <div class="m-0 p-0 pt-5">
                ...
                <p v-if="productPrice != null" class="fs-6 pt-1 pb-4 text-secondary">{{ lang('totalcostis') }}</p>
                <p v-else class="fs-6 pt-1 pb-4 text-secondary">
                    {{ lang('firstselectone') }}
                </p>
            </div>

            <div v-if="productPrice > 0" class="d-flex flex-row justify-content-between m-0 p-0 my-3 ps-md-4">
                <div class="m-0 p-0">
                    <span v-if="CurrenciesRatioCloudToWhmcs != null" class="fs-5 fw-medium text-primary px-1">
                        {{ formatCostHourly(ConverFromAutoVmToWhmcs(productPrice/30/24)) }} {{ userCurrencySymbolFromWhmcs }}
                    </span>
            ...
            <div v-if="productPrice == 0" class="d-flex flex-row justify-content-between m-0 p-0 my-3 ps-md-4">
                <div class="m-0 p-0">
                    <span class="fs-5 fw-medium text-primary px-1">
                        {{ lang('free') }}
                    </span>
                </div>
            </div>
